...
## 经典diff优化策略
![经典diff优化策略](./images/diff.jpg)

### 新增情况
![新增情况](./images/add.jpg)

### 删除一个节点情况
![删除一个节点情况](./images/delete-single.jpg)

### 删除多个节点情况
![删除多个节点情况](./images/delete-mutile.jpg)

### 新前与旧后的情况
![新前与旧后的情况](./images/newStart-oldEnd.jpg)

### 新后与旧前的情况
![新后与旧前的情况](./images/newEnd-oldStart.jpg)
...
btn.addEventListener("click", function() {
  // const newNode = h('section',{},'好啊好啊')
  // const newNode = h('section',{},[
  //     h('h1',{},'我是新来的h1'),
  //     h('h2',{},'我是新来的h2')
  // ])
  const newNode = h("ul", {}, [
